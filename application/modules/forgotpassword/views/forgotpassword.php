...
<head>
  ...
  <title>UMKM Tohaga | Forgot Password</title>
        ...
        <div class="h-100 no-gutters row">
          ...
          <div class="h-100 d-flex bg-white justify-content-center align-items-center col-md-12 col-lg-8">
            <div class="mx-auto app-login-box col-sm-12 col-md-10 col-lg-9">
              ...
              <div>
                <form class="form-signin" action="<?php echo base_url(); ?>forgotpassword/reset" method="post">
                  <div class="form-row">
                    <div class="col-md-12">
                  ...
                  <div class="d-flex align-items-center">
                    <div class="ml-auto">
                      <a href="auth" class="btn-lg btn btn-link">Back to login</a>
