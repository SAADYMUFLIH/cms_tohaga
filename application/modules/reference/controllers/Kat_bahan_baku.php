...
class Kat_bahan_baku extends CI_Controller
{
    private $menu = 'Home';
    private $idx_base_url = 'kat_bahan_baku/ajaxPaginationData';
    private $model_name = 'kat_bahan_baku_model';
    private $page_topic = 'kat_bahan_baku';
    private $controller = 'reference/kat_bahan_baku';
    private $views_folder_group = 'kat_bahan_baku/';
    private $user_id = '';
    private $key_edit = 'id_kat_bahan_baku';
    private $search_place_holder = 'Untuk pencarian data, ketik Nama Kategori Bahan Baku, lalu tekan enter';
    private $col_title = array('Kategori Bahan Baku', 'Create At', 'Update At');
    private $list_field = array('name', 'create_at', 'update_at');
    private $page_title = 'Data Kategori Bahan Baku';
    private $table_width = '100';
    private $tblname = 'tbl_kat_bahan_baku';
    private $export = true;
    ...
    public function displayInputForm()
    {
        $data = array(
            'controller' => $this->controller,
            'form_input_title' => 'Input Data kategori Bahan Baku',
            'root' => $this->menu,
        );
    ...
    public function displayImportForm()
    {
        $data = array(
            'controller' => $this->controller,
            'form_input_title' => 'Import Data kategori Bahan Baku',
            'root' => $this->menu,
        );
    ...
    public function saveData()
    {
        ...
        if (is_data_exist('tbl_kat_bahan_baku', 'name', "name = '$validate_value'")) {
            $arr_response = array(
                'error' => 'true',
                'msg' => 'Nama kategori Bahan Baku <span class="badge badge-warning">' . $validate_value . '</span>' . MSG_DATA_ALREADY_EXIST,
            );
    ...
    public function editData()
    {
        ...
        $data = array(
            ...
            'form_input_title' => 'Edit Data Kategori Bahan Baku',
            'root' => $this->menu,
            'dt_init' => $init_data,
        );
