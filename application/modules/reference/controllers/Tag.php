...
{
    private $menu = 'Home';
    private $idx_base_url = 'tag/ajaxPaginationData';
    private $model_name = 'tag_model';
    private $page_topic = 'tag';
    private $controller = 'reference/tag';
    private $views_folder_group = 'tag/';
    private $user_id = '';
    private $key_edit = 'id_tag';
    private $search_place_holder = 'Untuk pencarian data, ketik Nama Tag, lalu tekan enter';
    private $col_title = array('Tag', 'Create At', 'Update At');
    private $list_field = array('name', 'create_at', 'update_at');
    private $page_title = 'Data Tag';
    private $table_width = '100';
    private $tblname = 'tbl_tag';
    ...
    public function displayInputForm()
    {
        $data = array(
            'controller' => $this->controller,
            'form_input_title' => 'Input Data Tag',
            'root' => $this->menu,
        );
    ...
    public function saveData()
    {
        ...
        if (is_data_exist('tbl_tag', 'name', "name = '$validate_value'")) {
            $arr_response = array(
                'error' => 'true',
                'msg' => 'Nama Tag <span class="badge badge-warning">' . $validate_value . '</span>' . MSG_DATA_ALREADY_EXIST,
            );
    ...
    public function editData()
    {
        ...
        $data = array(
            ...
            'form_input_title' => 'Edit Data Tag',
            'root' => $this->menu,
            'dt_init' => $init_data,
        );
    ...
    public function tag_ajax()
    {
        ...
        $searchs = $this->$nm_model->getSearch($q);
        $json = [];
