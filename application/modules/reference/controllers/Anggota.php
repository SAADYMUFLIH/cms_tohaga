...
{
    private $menu = 'Home';
    private $idx_base_url = 'anggota/ajaxPaginationData';
    private $model_name = 'anggota_model';
    private $page_topic = 'anggota';
    private $controller = 'reference/anggota';
    private $views_folder_group = 'anggota/';
    private $user_id = '';
    private $key_edit = 'id_anggota';
    private $search_place_holder = 'Untuk pencarian data, ketik Nama Anggota Dewan, lalu tekan enter';
    private $col_title = array('Anggota Dewan', 'Create At', 'Update At');
    private $list_field = array('name', 'create_at', 'update_at');
    private $page_title = 'Data Anggota Dewan';
    private $table_width = '100';
    private $tblname = 'tbl_anggota';
    private $export = true;
    ...
    public function displayInputForm()
    {
        $data = array(
            'controller' => $this->controller,
            'form_input_title' => 'Input Data Anggota Dewan',
            'root' => $this->menu,
        );
    ...
    public function displayImportForm()
    {
        $data = array(
            'controller' => $this->controller,
            'form_input_title' => 'Import Data Anggota Dewan',
            'root' => $this->menu,
        );
    ...
    public function saveData()
    {
        ...
        if (is_data_exist('tbl_anggota', 'name', "name = '$validate_value'")) {
            $arr_response = array(
                'error' => 'true',
                'msg' => 'Nama anggota dewan <span class="badge badge-warning">' . $validate_value . '</span>' . MSG_DATA_ALREADY_EXIST,
            );
    ...
    public function editData()
    {
        ...
        $data = array(
            ...
            'form_input_title' => 'Edit Data Anggota Dewan',
            'root' => $this->menu,
            'dt_init' => $init_data,
        );
