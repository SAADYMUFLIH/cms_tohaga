...
class Kat_prod extends CI_Controller
{
    private $menu = 'Home';
    private $idx_base_url = 'kat_prod/ajaxPaginationData';
    private $model_name = 'kat_prod_model';
    private $page_topic = 'kat_prod';
    private $controller = 'reference/kat_prod';
    private $views_folder_group = 'kat_prod/';
    private $user_id = '';
    private $key_edit = 'id_kat_prod';
    private $search_place_holder = 'Untuk pencarian data, ketik Nama Kategori Produk, lalu tekan enter';
    private $col_title = array('Kategori Produk', 'Create At', 'Update At');
    private $list_field = array('name', 'create_at', 'update_at');
    private $page_title = 'Data Kategori Produk';
    private $table_width = '100';
    private $tblname = 'tbl_kat_prod';
    private $export = true;
    ...
    public function displayInputForm()
    {
        $data = array(
            'controller' => $this->controller,
            'form_input_title' => 'Input Data kategori Produk',
            'root' => $this->menu,
        );
    ...
    public function displayImportForm()
    {
        $data = array(
            'controller' => $this->controller,
            'form_input_title' => 'Import Data kategori Produk',
            'root' => $this->menu,
        );
    ...
    public function saveData()
    {
        ...
        if (is_data_exist('tbl_kat_prod', 'name', "name = '$validate_value'")) {
            $arr_response = array(
                'error' => 'true',
                'msg' => 'Nama kategori Produk <span class="badge badge-warning">' . $validate_value . '</span>' . MSG_DATA_ALREADY_EXIST,
            );
    ...
    public function editData()
    {
        ...
        $data = array(
            ...
            'form_input_title' => 'Edit Data Kategori Produk',
            'root' => $this->menu,
            'dt_init' => $init_data,
        );
