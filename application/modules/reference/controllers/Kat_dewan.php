...
class Kat_dewan extends CI_Controller
{
    private $menu = 'Home';
    private $idx_base_url = 'kat_dewan/ajaxPaginationData';
    private $model_name = 'kat_dewan_model';
    private $page_topic = 'kat_dewan';
    private $controller = 'reference/kat_dewan';
    private $views_folder_group = 'kat_dewan/';
    private $user_id = '';
    private $key_edit = 'id_kat_dewan';
    private $search_place_holder = 'Untuk pencarian data, ketik Nama Kategori Kolom Anggota Dewan, lalu tekan enter';
    private $col_title = array('Kategori Kolom Anggota Dewan', 'Create At', 'Update At');
    private $list_field = array('name', 'create_at', 'update_at');
    private $page_title = 'Data Kategori Kolom Anggota Dewan';
    private $table_width = '100';
    private $tblname = 'tbl_kat_dewan';
    private $export = true;
    ...
    public function displayInputForm()
    {
        $data = array(
            'controller' => $this->controller,
            'form_input_title' => 'Input Data kategori kolom anggota dewan',
            'root' => $this->menu,
        );
    ...
    public function displayImportForm()
    {
        $data = array(
            'controller' => $this->controller,
            'form_input_title' => 'Import Data kategori kolom anggota dewan',
            'root' => $this->menu,
        );
    ...
    public function saveData()
    {
        ...
        if (is_data_exist('tbl_kat_dewan', 'name', "name = '$validate_value'")) {
            $arr_response = array(
                'error' => 'true',
                'msg' => 'Nama kategori kolom anggota dewan <span class="badge badge-warning">' . $validate_value . '</span>' . MSG_DATA_ALREADY_EXIST,
            );
    ...
    public function editData()
    {
        ...
        $data = array(
            ...
            'form_input_title' => 'Edit Data Kategori Kolom Anggota Dewan',
            'root' => $this->menu,
            'dt_init' => $init_data,
        );
