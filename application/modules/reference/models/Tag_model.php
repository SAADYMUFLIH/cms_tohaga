...
{
    private $selected_field = "tbl_tag.*";
    private $tbl_name = "tbl_tag";
    private $field_search = array("name");
    private $field_id = "id_tag";
    ...
    public function exportToExcel($xls_data)
    {
        ...
        $arr_col = array('No', 'Nama tag', 'Kecamatan', 'Create At', 'Update At');
    ...
    public function getRwByIdKel($id_tag)
    {
