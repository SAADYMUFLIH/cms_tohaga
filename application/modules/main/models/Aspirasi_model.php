...
{
    private $selected_field = "aspirasi.*";
    private $tbl_name = "tbl_aspirasi as aspirasi";
    private $tbl_name_for_insert = "tbl_aspirasi";
    private $field_search = array("title");
    private $field_id = "id_aspirasi";
    ...
    public function remove_img($arr_dt, $id_key, $field)
    {
        ...
        if ($this->db->update($this->tbl_name, $arr_dt)) {
            if (file_exists('assets/images/file_aspirasi/' . $existing_image)) {
                unlink('assets/images/file_aspirasi/' . $existing_image);
    ...
    public function exportToExcel($xls_data)
    {
        ...
        $arr_col = array("No", 'NIK', 'Nama Aspirasi', 'No. BPJS', 'Tempat Lahir', 'Tgl Lahir', 'Jenis Kelamin', 'Kabupaten', 'Kecamatan', 'Kelurahan', 'Alamat', 'No. HP', 'Pendidikan', 'Pekerjaan', 'Status Kawin', 'Gol. Darah', 'Create At', 'Update At');
    ...
    public function getUnred()
    {
        $this->db->select("COUNT(*) as unread_notif");
        $this->db->from($this->tbl_name);
