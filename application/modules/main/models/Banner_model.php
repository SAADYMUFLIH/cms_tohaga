...
{
    private $selected_field = "tbl_banner.*";
    private $tbl_name = "tbl_banner";
    private $tbl_name_for_insert = "tbl_banner";
    private $field_search = array("img");
    private $field_id = "id_banner";
    ...
    //     $arr_col = array("No", 'NIK', 'Nama Banner', 'No. BPJS', 'Tempat Lahir', 'Tgl Lahir', 'Jenis Kelamin', 'Kabupaten', 'Kecamatan', 'Kelurahan', 'Alamat', 'No. HP', 'Pendidikan', 'Pekerjaan', 'Status Kawin', 'Gol. Darah', 'Create At', 'Update At');
