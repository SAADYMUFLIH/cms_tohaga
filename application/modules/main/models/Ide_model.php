...
{
    private $selected_field = "ide.*";
    private $tbl_name = "tbl_ide_startup as ide";
    private $tbl_name_for_insert = "tbl_ide_startup";
    private $field_search = array("title");
    private $field_id = "id_ide_startup";
    ...
    public function remove_img($arr_dt, $id_key, $field)
    {
        ...
        if ($this->db->update($this->tbl_name, $arr_dt)) {
            if (file_exists('assets/images/file_ide/' . $existing_image)) {
                unlink('assets/images/file_ide/' . $existing_image);
    ...
    public function exportToExcel($xls_data)
    {
        ...
        $arr_col = array("No", 'NIK', 'Nama Ide', 'No. BPJS', 'Tempat Lahir', 'Tgl Lahir', 'Jenis Kelamin', 'Kabupaten', 'Kecamatan', 'Kelurahan', 'Alamat', 'No. HP', 'Pendidikan', 'Pekerjaan', 'Status Kawin', 'Gol. Darah', 'Create At', 'Update At');
