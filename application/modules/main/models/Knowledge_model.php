...
{
    private $selected_field = "posts.*, ss.name as kat_dewan, ta.name as anggota";
    ...
    public function getRows($params = array())
    {
        ...
        $this->db->from($this->tbl_name);
        $this->db->join("tbl_kat_dewan as ss", "ss.id_kat_dewan = posts.id_kat_dewan", "left");
        $this->db->join("tbl_anggota as ta", "ta.id_anggota = posts.id_anggota", "left");
        $this->db->where("id_kat_posts = 6");
    ...
    public function exportToExcel($xls_data)
    {
        ...
        $arr_col = array("No", 'NIK', 'Nama Knowledge', 'No. BPJS', 'Tempat Lahir', 'Tgl Lahir', 'Jenis Kelamin', 'Kabupaten', 'Kecamatan', 'Kelurahan', 'Alamat', 'No. HP', 'Pendidikan', 'Pekerjaan', 'Status Kawin', 'Gol. Darah', 'Create At', 'Update At');
