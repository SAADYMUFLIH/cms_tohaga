...
{
    private $selected_field = "ebook.*";
    private $tbl_name = "tbl_ebook as ebook";
    private $tbl_name_for_insert = "tbl_ebook";
    private $field_search = array("title");
    private $field_id = "id_ebook";
    ...
    public function remove_img($arr_dt, $id_key, $field)
    {
        ...
        if ($this->db->update($this->tbl_name, $arr_dt)) {
            if (file_exists('assets/images/file_ebook/' . $existing_image)) {
                unlink('assets/images/file_ebook/' . $existing_image);
    ...
    public function exportToExcel($xls_data)
    {
        ...
        $arr_col = array("No", 'NIK', 'Nama Ebook', 'No. BPJS', 'Tempat Lahir', 'Tgl Lahir', 'Jenis Kelamin', 'Kabupaten', 'Kecamatan', 'Kelurahan', 'Alamat', 'No. HP', 'Pendidikan', 'Pekerjaan', 'Status Kawin', 'Gol. Darah', 'Create At', 'Update At');
