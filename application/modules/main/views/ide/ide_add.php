...
<div class="modal-header">
        ...
        <div class="modal-body" id="scroll_div_add">
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <?php echo generateStandardInputBox("Nama", '', "name", isset($dt_init->name) ? $dt_init->name : '', true, '', '', '', '', true) ?>
                    </div>
                    <div class="col-md-6">
                        <?php echo generateStandardInputBox("UMKM", '', "umkm", isset($dt_init->umkm) ? $dt_init->umkm : '', true, '', '', '', '', true) ?>
                    </div>
                    <div class="col-md-6">
                        <?php echo generateStandardInputBox("Tanggal", '', "tanggal", isset($dt_init->tanggal) ? $dt_init->tanggal : '', true, '', '', '', '', true) ?>
                    </div>
                    <div class="col-md-12">
                        <?php
                    ...
                    <!-- <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <img class="img img-fluid" src="http://localhost/apitohaga/assets/images/img_aspirasi/<?php //$dt_init->img ?>">
                        </div>
                    </div> -->
                </div>
            </div>
    ...
    <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-danger btn-sm"><i class="fas fa-sign-out-alt"></i> Close</button>
    </div>
    <!-- Button end here -->
</form>
