            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <label for="roles_id">Anggota</label><br>
                            <?php //echo $cbo_anggota ?>
                        </div> -->
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <?php
                            $profile_pic =  empty($dt_init->img) ? '' : 'assets/images/banner/' . $dt_init->img;
                            ?>
                            <input type="file" id="img" name="img" data-default-file="<?php echo $profile_pic  ?>" class="dropify" data-allowed-file-extensions="gif jpg jpeg png" data-show-remove="false" data-height="150">
                        </div>
                    </div>
