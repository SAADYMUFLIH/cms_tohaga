        ...
        <div class="modal-body" id="scroll_div_add">
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="roles_id">Kategori Regulasi</label><br>
                            <?php //echo $cbo_cat 
                            ?>
                            <?php
                            $selection = array(1 => 'SOP Pengurusan', 2 => 'Dinas Terkait');
                            echo '<select name="id_kat_regulasi" class="form-control form-control-sm" required>';

                            foreach ($selection as $key => $val) {
                                if (isset($dt_init->id_kat_regulasi)) {
                                    $selected = ($dt_init->id_kat_regulasi == $key) ? "selected" : "";
                                }
                    ...
                    <div class="col-md-6">
                        <?php echo generateStandardInputBox("Judul regulasi", '', "title", isset($dt_init->title) ? $dt_init->title : '', true) ?>
                    </div>
                    <div class="col-md-12">
                        <?php
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="roles_id">Upload file regulasi</label><br>
                            <?php
                            $profile_pic =  empty($dt_init->img) ? '' : 'assets/images/file_regulasi/' . $dt_init->img;
                            ?>
                            <input type="file" id="img" name="img" data-default-file="<?php echo $profile_pic  ?>" class="dropify" data-allowed-file-extensions="pdf" accept="application/pdf" data-height="150">
                        </div>
                    </div>
                </div>
            </div>
